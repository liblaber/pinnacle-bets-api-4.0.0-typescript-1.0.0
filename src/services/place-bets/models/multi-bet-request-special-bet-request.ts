 ...
 */
export const multiBetRequestSpecialBetRequest = z.object({
 ...
 */
export const multiBetRequestSpecialBetRequestResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const multiBetRequestSpecialBetRequestRequest = z
  .object({ bets: z.array(specialBetRequestRequest).nullish() })
  .transform((data) => ({
    bets: data['bets'],
  }));
